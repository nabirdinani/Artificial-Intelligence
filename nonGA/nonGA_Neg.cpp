...
int main ( int argc, char const *argv[] )
{
	...
	//3-input negation
	correctOutput = bitset<8>(string("11110000")); 
	correctOutput2 = bitset<8>(string("11001100")); 
	correctOutput3 = bitset<8>(string("10101010")); 
	correctOutputs.push_back(correctOutput);
	correctOutputs.push_back(correctOutput2);
	correctOutputs.push_back(correctOutput3);
	vector<Circuit> cBox;
	Circuit X;
	X.id = 1;
